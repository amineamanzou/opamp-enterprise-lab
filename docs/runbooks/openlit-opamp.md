...
- functional and maintainability matrix;
...
9. Maintainability: record deployment friction, port conflicts, UI/API alignment, remote config safety, TLS operations, and exit friction. Do not run OpenLit volumetry paliers in this scenario; protocol fan-out belongs to the underlying OpAMP implementation tests.
